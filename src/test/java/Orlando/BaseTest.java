 ...
 */
public class BaseTest extends NavigationHelper implements ProjectConfig, SQLHelper {
    ...
    public void initBrowser() throws IOException {
        if (driver == null) {
            ...
            login(LoginHelper.getUrl(), LoginHelper.getTenant(), LoginHelper.getUserName(), LoginHelper.getTenantPassword());
        }
    }
