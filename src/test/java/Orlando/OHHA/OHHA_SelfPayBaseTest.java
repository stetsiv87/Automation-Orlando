 ...
 */
public class OHHA_SelfPayBaseTest extends BaseTest{

    private static String query ="Self Pay.sql";
    private static String filename_project = "Self Pay.properties";
    private static String foldername_project ="OHHA";


    public OHHA_SelfPayBaseTest() throws IOException {
